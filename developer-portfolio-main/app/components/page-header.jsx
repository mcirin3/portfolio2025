...
function PageHeader({ eyebrow = "Discover", title, subtitle, ctaLabel, ctaHref, ctaTarget }) {
  return (
    <section className="relative mb-12 overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-white/5 via-white/0 to-white/5 p-6 shadow-[0_25px_120px_-60px_rgba(0,0,0,0.8)] sm:p-10 lg:mb-16">
      <div className="pointer-events-none absolute -left-10 -top-16 h-56 w-56 rounded-full bg-[var(--secondary-color)]/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-10 -right-14 h-56 w-56 rounded-full bg-[var(--primary-color)]/20 blur-3xl" />
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        {ctaLabel && ctaHref ? (
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[var(--primary-color)] via-[var(--accent-color)] to-[var(--secondary-color)] px-5 py-3 text-sm font-semibold uppercase tracking-[0.14em] text-white shadow-[0_15px_80px_-35px_rgba(17,24,39,0.95)] transition-transform duration-200 hover:-translate-y-0.5"
          >
            {ctaLabel}
          </Link>
        ) : null}
