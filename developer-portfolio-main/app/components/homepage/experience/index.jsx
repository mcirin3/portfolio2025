      ...
      <div className="py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="flex justify-center items-start">
            <div className="relative w-full h-full min-h-[320px] rounded-3xl border border-white/5 bg-gradient-to-br from-[#111827]/80 via-[#18243d]/60 to-[#00e5ff]/20 p-6 shadow-[0_25px_90px_-50px_rgba(0,0,0,0.6)] overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center gap-4 pt-4">
                ...
                <p className="text-[#00e5ff] text-sm uppercase tracking-[0.18em]">Experience</p>
                  ...
                  <GlowCard key={experience.id} identifier={`experience-${experience.id}`}>
                    <div className="p-3 relative">
                      ...
                      <div className="flex justify-center">
                        <p className="text-xs sm:text-sm text-[#6e7bff]">
                          {experience.duration}
                        </p>
                      </div>
                      <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-r from-[#111827]/70 via-[#18243d]/70 to-[#00e5ff]/25 px-3 py-5">
                        <div className="flex items-center gap-x-6">
                          <div className="text-[#00e5ff] transition-all duration-300 hover:scale-125">
